        ...
        <form className="donation-form" onSubmit={addDonation}>
          ...
          <div className="form-fields">
            ...
            {money == 1 ? (
                ...
                <>
                  <div className="req">
                    <strong>Cuenta Ahorros</strong>
                  </div>
                  <div className="cuentaNum">
                    <label> ---- Bancolombia ----</label> 008 - 017365 -05
                  </div>
                </>
              ...
              <>
                ...
                <select
                  name="destination_don"
                  onChange={handleInput}
                  value={form.destination_don}
                >
          ...
          <div className="send-form">
            <div className="terms-form">
              ...
              <label className="terms">
                He leído y acepto el aviso de privacidad y política de
          ...
          <Link to="/Session" className="admin-portal-link">
            <div className="admin-portal">
              <button>
                <BsFillPersonFill className="admin-icon"></BsFillPersonFill>
              </button>
